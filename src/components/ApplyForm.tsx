...
import { company, pricing, googleAdsId } from "@/lib/content";

const SERVICE_OPTIONS = [
  { slug: "llc-ein-itin", label: `Complete package — LLC + EIN + ITIN ($${pricing.bundle.price} + state fee)` },
  { slug: "llc", label: `US LLC + EIN + Business Address ($${pricing.llc.price} + state fee)` },
  { slug: "itin", label: `ITIN Application ($${pricing.itin.price})` },
...
export default function ApplyForm() {
  ...
  const validInitial = SERVICE_OPTIONS.some((s) => s.slug === initial) ? initial : "llc-ein-itin";
